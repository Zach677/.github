...
This document describes the process of contributing to xxx. It is intended
for anyone considering opening an **issue**, **discussion** or **pull request**.
For people who are interested in developing xxx and technical details behind
it, please check out our ["Developing xxx"](HACKING.md) document as well.

> [!NOTE]
>
> I'm sorry for the wall of text. I'm not trying to be difficult and I do
> appreciate your contributions. xxx is a personal project for me that
...
> [!IMPORTANT]
>
> The xxx project allows AI-**assisted** _code contributions_, which
> must be properly disclosed in the pull request.

If you are using any kind of AI assistance while contributing to xxx,
...
allowed, as it goes against the methodology and ethos behind xxx.
...
If you intend to submit AI-generated assets to xxx, sorry,
...
Community moderators and xxx maintainers reserve the right to mark
...
["contributor friendly"]: https://github.com/Zach677/xxx/issues?q=is%3Aissue%20is%3Aopen%20label%3A%22contributor%20friendly%22

### I'd like to translate xxx to my language

We have written a [Translator's Guide](po/README_TRANSLATORS.md) for
everyone interested in contributing translations to xxx.
...
[closed issues]: https://github.com/Zach677/xxx/issues?q=is%3Aissue%20state%3Aclosed
[discussions]: https://github.com/Zach677/xxx/discussions?discussions_q=is%3Aclosed
["Issue Triage"]: https://github.com/Zach677/xxx/discussions/new?category=issue-triage
...
["Feature Requests, Ideas"]: https://github.com/Zach677/xxx/discussions/new?category=feature-requests-ideas
...
those are for general discussion about terminals and xxx development
...
> the ["Feature Requests, Ideas"] category. If xxx is behaving
...
[Q&A discussion]: https://github.com/Zach677/xxx/discussions/new?category=q-a
...
The xxx [issue tracker](https://github.com/Zach677/xxx/issues)
is for _actionable items_.

Unlike some other projects, xxx **does not use the issue tracker for
discussion or feature requests**. Instead, we use GitHub
[discussions](https://github.com/Zach677/xxx/discussions) for that.
...
> working on xxx.** If you're a user reporting an issue, you can
